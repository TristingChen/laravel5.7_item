...
$(document).ready(function() {  
	...
	'<li><a href="/front/neko-framework/css/color/neko-framework-blue.css" style="background:#136597">Dark blue</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-dodger.css" style="background:#2196f3">Dodger</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-light-blue.css" style="background:#44BCDD">Light blue</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-sea-green.css" style="background:#3CB6B6">Sea green</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-green.css" style="background:#A4C618">Green</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-yellow.css" style="background:#FFE509">Yellow</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-orange.css" style="background:#EA761E">Orange</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-red.css" style="background:#E44832">Red</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-pink.css" style="background:#e91e63">Pink</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-purple.css" style="background:#7f378a">Purple</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-marsala.css" style="background:#965251">Marsala</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-gold.css" style="background:#B39964">Pink</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-chocolate.css" style="background:#5E4D42">Coffee</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-olive.css" style="background:#848478">Olive</a></li>' +
	'<li><a href="/front/neko-framework/css/color/neko-framework-silver.css" style="background:#A1B4B8">Silver</a></li>' +
...
/*
    ...
    */
    ...
    s.src = "/front/js-plugins/jquery-cookie/jquery.cookie.js";
    $("body").append(s);  
...
$('#rs-slider-fullwidth').css('visibility', 'visible');
	...
	*/	
	...
	if($('#rs-slider-elements').length){
		$('.tp-banner').show().revolution(
		{
			videoJsPath:"/front/js-plugins/rs-plugin/videojs/",
